...
public class ErrorUtils {
    ...
    private static final String NO_CONNECTION_ERROR = VideoCall.getInstance().getString(R.string.no_connection_error);
    private static final String NO_RESPONSE_TIMEOUT = VideoCall.getInstance().getString(R.string.no_responce_timeout);
    ...
    public static Snackbar showSnackbar(View view, @StringRes int errorMessage, Exception e,
        ...
        if (noConnection || timeout) {
            ...
            return showSnackbar(view, errorMessage, VideoCall.getInstance().getString(R.string.no_internet_connection), actionLabel, clickListener);
        } else {
    ...
    public static Snackbar showSnackbar(View view, @StringRes int errorMessage, String error,
                                        @StringRes int actionLabel, View.OnClickListener clickListener) {
        String errorMessageString = VideoCall.getInstance().getString(errorMessage);
