...
public class UiUtils {
    ...
    public static Drawable getGreyCircleDrawable() {
        return getColoredCircleDrawable(VideoCall.getInstance().getResources().getColor(R.color.color_grey));
    }
    ...
    public static Drawable getColoredCircleDrawable(@ColorInt int color) {
        GradientDrawable drawable = (GradientDrawable) VideoCall.getInstance().getResources().getDrawable(R.drawable.shape_circle);
    ...
    public static int getCircleColor(@IntRange(from = RANDOM_COLOR_START_RANGE, to = RANDOM_COLOR_END_RANGE)
        ...
        int colorId = VideoCall.getInstance().getResources()
                .getIdentifier(colorIdName, "color", VideoCall.getInstance().getPackageName());

        return VideoCall.getInstance().getResources().getColor(colorId);
    }
